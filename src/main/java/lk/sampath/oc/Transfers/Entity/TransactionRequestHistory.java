...
public class TransactionRequestHistory {
	...
	@Column(name = "PUSH_NOTIFICATION_SAVED")
	...
	public String getPushNotificationSaved() {
		return pushNotificationSaved;
	}

	public void setPushNotificationSaved(String pushNotificationSaved) {
		this.pushNotificationSaved = pushNotificationSaved;
	}
	/**
	...
	public String toString() {
		return "TransactionRequest [transactionId=" + transactionId + ", externalId=" + externalId + ", userName="
				...
				+ ", commissionAmount=" + commissionAmount + ", commissionStatus=" + commissionStatus 
				+ ", message=" + message
				+ "]";
	}
